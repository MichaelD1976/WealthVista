...
def main():
    ...
    with col1:
        with st.container(border=True):
            ...
            stocks_weight = st.slider('Enter Approximate Portfolio Stocks %', min_value = 0, max_value = 100, value = 70, step = 2, key='stocks_weight')
            bonds_weight = st.slider('Enter Approximate Portfolio Bonds %', min_value = 0, max_value = 100, value = 20, step = 2, key='bonds_weight')
